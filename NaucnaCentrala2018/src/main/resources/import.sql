...
INSERT INTO `nc`.`magazine` (`id`, `name`, `main_editor_id`, `payment_method`, `issnnumber`, `merchant_id`, `merchant_password`, `amount_mag`) VALUES ('5','Saskin magazin','2', 'open-access','5561-3971','o30sldmcv81yt6j5nf9q2nv0m4u7v9','2',31);
...
INSERT INTO `nc`.`user_author` (`id`, `username`, `password`, `is_author`, `membership_fee_id`, `name`) VALUES ('1','gagi','$2a$10$2sQKNmLgwfIyHkmHNqT8V.ib75p8RKZI7.CciEc5NBO/yPkVYPeue',1,'1','Dragan');
