...
public class EditorSA {
	...
	public EditorSA(Long id, String name, String surname, String city, String country, String email,
			String username, String password, Set<Role> roles, ScientificArea scientificArea) {
